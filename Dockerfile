...
RUN python3 -m pip install --no-cache-dir pandas scipy matplotlib seaborn opencv-python-headless imageio ffmpeg pillow tqdm jupyterlab ipywebrtc ipython IPython ipywidgets pydot holidays
